...
def get_place_amenities(place_id):
    ...
    if not place:
        abort(404)
    return jsonify([storage_t == "db" and amenity.to_dict() or amenity.id for
...
def delete_place_amenity(place_id, amenity_id):
    ...
    elif storage_t != 'db' and amenity.id in place.amenities:
...
def post_place_amenity(place_id, amenity_id):
    ...
    if storage_t == 'db':
        ...
        storage.save()
        return make_response(jsonify(amenity.id), 201)
    storage.save()
